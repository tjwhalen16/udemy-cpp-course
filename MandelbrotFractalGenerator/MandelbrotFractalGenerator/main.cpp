...
int main()
{
	...
	fractal_creator.AddRange(0.3, ColorRgb(0, 255, 0));
	fractal_creator.AddRange(0.5, ColorRgb(0, 0, 255));
	fractal_creator.AddRange(1.0, ColorRgb(255, 0, 0));
